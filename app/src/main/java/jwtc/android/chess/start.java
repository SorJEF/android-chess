...
import jwtc.android.chess.pubnub.PubnubUsernameActivity;
...
public class start extends Activity/*ListActivity*/  {
	...
	public void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View arg0) {
				...
				try{
					...
					if(s.equals(getString(R.string.start_play))){
						...
						i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
						startActivity(i);
					} else if(s.equals(getString(R.string.start_pubnub))){
						i.setClass(start.this, PubnubUsernameActivity.class);
						//i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
						startActivity(i);
					}
				} catch(Exception ex){
		...
		((Button)findViewById(R.id.StartButtonPubnub)).setOnClickListener(ocl);
